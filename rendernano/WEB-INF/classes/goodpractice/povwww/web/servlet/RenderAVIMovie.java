...
public class RenderAVIMovie extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			String aviOut = Configuration.stripExtension(imageFile) + ".avi";
			...
			I_Job job = new PovAVIJob(outputFile, as);
			int exVal = -1;
			try {
...
//			-mf fps=8:type=png -ovc lavc -lavcopts vcodec=flv:vqscale=2:keyint=5 -ofps 10 -lavfopts i_certify_that_my_video_stream_does_not_use_b_frames -of lavf
			...
			+ "*.png "
			+ "-mf fps=25:type=png "																																																					
			+ "-ovc lavc -lavcopts vcodec=msmpeg4v2:vbitrate=2400:vhq  -o "
			+ userHome+Constants.DIR_MEASURE+aviOut;;
			
			
			Logger.dev(this, "Runnig-mencoder");
			 I_Job mencodeJob1 = new MEncoderJob(cmd1);
			 
			 
			 Logger.dev(this, "mencoder:" + mencodeJob1.getCommand());
