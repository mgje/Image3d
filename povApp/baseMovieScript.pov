...
#declare P1 = <-3.00, 3.00, -3.00>;
#declare P2 = < -3.00, 2.00, -1.00>;
#declare P3 = < -2.00, 1.00, -0.00>;
#declare P4 = < -2.00, 1.20,  0.50>;
#declare P5 = < 0.00, 1.50,  1.50>;
#declare P6 = < 1.00, 1.20,  0.50>;
#declare P7 = < 2.00, 1.70, 1.50>;

#declare O_Korrugation=1;      
#declare O_y_Rotation= 0;
  
#declare SCALE = #@Distance:2;3.5;3;2.5;2;1.5;1;0.8;0.7:2;3.5;3;2.5;2;1.5;1;0.8;0.7@;   
#declare O_ROTATION = #@Rotation:0;90;180;270:0;90;180;270@;  
#declare PATH = #@CameraPath:1;2;3;4;5;6;7;8;9:PATH1;PATH2;PATH 3;PATH 4;PATH 5;PATH 6;PATH 7;PATH 8;PATH 9@;

////---------------COLOR--------------------
        #declare My_Pigment = pigment {
                        gradient y       //this is the PATTERN_TYPE
                        color_map {
        #@ColorPattern:[0.04 color rgb <0,0.0,0.0>][0.32 color rgb <1,0.65,0>][1.00 color rgb <1,1.0,0.5>];
...
p1;p2;p3;p4;p5;p6:povwww.web.applet.GradientApplet@
 ...
 ///---------------------------------------------------------------------
...
#if (PATH=1)       
       #if (clock < 0.4)     
       #declare O_Korrugation = 0.01  ;    
       #declare KAMERA = <-DIST*(cos(2*pi*clock/0.4)),DIST/2.5,-DIST*(sin(2*pi*clock/0.4))>;       
       #declare My_Pigment = pigment {
                             gradient y       //this is the PATTERN_TYPE
                             color_map {
                             [0.0 rgb <0,0.08627451,0.1>][0.99 rgb <1,1,1>]
                             }    
       }    
       ...
       #declare O_Korrugation = (clock-0.4)*5  ;     
       #declare KAMERA = <-DIST*(cos(2*pi)),DIST/2.5,-DIST*(sin(2*pi))>;  
       #declare My_Pigment = pigment {
                             gradient y       //this is the PATTERN_TYPE
                             color_map {
                             [0.0 rgb <0,0.08627451,0.1>][0.99 rgb <1,1,1>]
       ...
       #if (clock >= 0.6)     
       #declare O_Korrugation = 1  ; 
       #declare KAMERA = <-DIST*(cos(2*pi/0.4*(clock-0.6))),DIST/2.5,-DIST*(sin(2*pi/0.4*(clock-0.6)))>;
       ...
       #if (clock < 0.3)     
       #declare O_Korrugation = 0.01  ;    
       #declare KAMERA = <0,DIST*(cos(2*pi*clock*0.6)),DIST*(sin(2*pi*clock*0.6))>;   
       #declare O_y_Rotation= 0;
       
       #end


       #if ((clock >= 0.3)&(clock < 0.5))     
       #declare O_Korrugation = (clock-0.3)*5  ;     
       #declare KAMERA = <0,DIST*(cos(2*pi*0.3*0.6)),DIST*(sin(2*pi*0.3*0.6))>;   
       #declare O_y_Rotation= 0;
       ...
       #declare O_Korrugation = 1  ;       
       #declare KAMERA = <0,DIST*(cos(2*pi*0.3*0.6)),DIST*(sin(2*pi*0.3*0.6))>;  
       #declare O_y_Rotation= (clock-0.5)*720;
       ...
       #if (clock < 0.49)     
       #declare O_Korrugation = 0.01;    
       #declare KAMERA = <0,DIST*(cos(2*pi*clock*0.3 )),DIST*(sin(2*pi*clock*0.3))>;      
       #declare O_y_Rotation= clock*50;
       #end

       #if ((clock >= 0.49) & (clock < 0.8))      
       #declare KAMERA = <0,DIST*(cos(2*pi*0.3*0.5)),DIST*(sin(2*pi*0.3*0.5))>;   
       #declare O_y_Rotation= 0.5*50;
       #declare O_Korrugation = (clock-0.48)*3.33;  
       #end
       ...
       #declare O_Korrugation = 1  ;    
       #declare KAMERA = <0,DIST,DIST>;      
       #declare O_y_Rotation= clock*360;
       ...
       #declare O_Korrugation = sin(pi*clock)+0.02  ;    
       #declare KAMERA = <0,DIST,DIST>;      
       #declare O_y_Rotation= clock*360;
...
height_field{
        ...
        rotate <0,O_ROTATION,0> 
        scale <1,#@ZFactor:0.1;0.2;0.4;0.8;1:1x;2x;4x;8x;10x:povwww.web.applet.ZFactor@,1>*2
        rotate <0,O_y_Rotation,0>
        scale <1,O_Korrugation,1>
}
